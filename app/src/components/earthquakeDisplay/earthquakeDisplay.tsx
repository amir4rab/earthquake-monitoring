                  ...
                  ({ id, date, dep, mag, state, city }) => ({
                    ...
                    items: [
                      ...
                      },
                      {
                        ...
                        el: (
                          <Text size='sm'>
                            {dep.toLocaleString(i18n.language) +
                      ...
                      },
                      {
                        ...
                        el: (
                          <Text size='sm'>
                            {getDate(date as unknown as number, i18n.language)}
                          </Text>
                        )
                      },
                      {
                        ...
                        el: (
                          <Text size='sm'>
                            {getHour(date as unknown as number, i18n.language)}
                          </Text>
                        )
                      }
                    ]
            ...
            <Text>
              <Trans
                ...
                components={[
                  <Anchor
                    key={0}
                    href={import.meta.env.VITE_TEHRAN_UNIVERSITY_URL}
                    target='_blank'
                    rel='noreferrer'
                  />
                ]}
