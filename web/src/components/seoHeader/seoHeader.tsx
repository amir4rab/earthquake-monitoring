  ...
  return (
    <>
      ...
      <link
        ...
        href='/assets/pwa-icons/touch-icon-iphone.png'
      />
      <link
        rel='apple-touch-icon'
        sizes='152x152'
        href='/assets/pwa-icons/touch-icon-ipad.png'
      />
      <link
        rel='apple-touch-icon'
        sizes='180x180'
        href='/assets/pwa-icons/touch-icon-iphone-retina.png'
      />
      <link
        rel='apple-touch-icon'
        sizes='167x167'
        href='/assets/pwa-icons/touch-icon-ipad-retina.png'
      />
      ...
      <meta
        name='twitter:image'
        content={websiteUrl + `/assets/banners/banner-${lang}.jpg`}
      />
