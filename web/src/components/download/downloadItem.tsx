...
const useStyles = createStyles((t) => ({
  card: {
    ...
    background: t.colorScheme === 'dark' ? t.colors[t.primaryColor][5] : t.colors[t.primaryColor][5],
    color: t.colorScheme === 'dark' ? t.colors.dark[5] : t.white,
    userSelect: 'none',
    transition: 'background .15s ease-in-out, transform .15s ease-in-out',
    [ '&:hover' ]: {
      background: t.colorScheme === 'dark' ? t.colors[t.primaryColor][4] : t.colors[t.primaryColor][4],
    },
    [ '&:active' ]: {
      background: t.colorScheme === 'dark' ? t.colors[t.primaryColor][3] : t.colors[t.primaryColor][3],
      transform: 'translate(0, .1rem)'
    },
    [ '&:disabled' ]: {
      background: t.colorScheme === 'dark' ? t.colors.dark[6] : t.colors.gray[6],
      color: t.white,
      cursor: 'not-allowed',
      width: '100%',
      opacity: .7
...
const DownloadItem = ({ downloadable= true, href, icon, subtitle, title, disabled= false, tooltipLabel }: DownloadItemProps) => {
